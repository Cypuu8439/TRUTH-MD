...
# Step 3: Force-install sharp prebuilt binary for linux-x64 with postinstall enabled
RUN npm install --platform=linux --arch=x64 --ignore-scripts=false --foreground-scripts sharp --legacy-peer-deps
